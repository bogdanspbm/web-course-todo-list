...
<div class="container-wrapper">
    <div class="container">
        ...
        <form action="/api/redis/create_task.php" method="POST" style="display: none;" class="new-task">
            <div class="new-task-container">
                <input name="title" id="title" class="title-input invisible-input" type="text" placeholder="Название задачи">
